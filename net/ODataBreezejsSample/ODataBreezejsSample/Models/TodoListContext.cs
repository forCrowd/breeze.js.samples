...
{
    internal sealed class DbMigrationsConfiguration : DbMigrationsConfiguration<TodoListContext>
    {
    ...
    public class TodoListContext : DbContext
    {
        ...
        private class TodoListContextInitializer : MigrateDatabaseToLatestVersion<TodoListContext, DbMigrationsConfiguration>
        {
        }
    }
}